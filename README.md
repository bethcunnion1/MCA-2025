...
<!--Version 1.0 -->
  ...
  <body>
    <h1>Week[1]</h1>
    <p>[The theme I chose for my portfolio is jazz and blues music. The artist of my first piece is Bill Withers, and the second is Wilbur Schwandt and Fabian Andre. 
      Potential challenges that could arise when working with music data is the complexity of finding music formats that will be compatible with musescore's software as it can be particular about this. 
